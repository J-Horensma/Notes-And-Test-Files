...
def insert_row_values(DB_FILE_PATH, DB_TABLE_NAME, COLUMNS, ROW_VALUES):
    try:
        ...
        #NOTE: ANY VALUE/S, BEING QUERIED WITH A PARAMETERIZED QUERY, IN "sqlite3" DATABASES, 
        #MUST BE A TUPLE OR LIST. WHEN PARAMETERIZING A SINGLE VALUE, IN A TUPLE, PLACE A COMMA,
