...
try:
    ...
    #IF THIS FILES NAME, MATCHES THE FIRST ENTRY IN "sys.argv", IT IS THIS FILE CALLING THE CODE.
    if __file__ == argv[0]:
    ...
    #IF "os.path.dirname(sys.argv[0])" MATCHES "os.getcwd()", ANOTHER PYTHON FILE, IS IMPORTING THIS FILE.
    #NOTE: AN IMPORTING PYTHON FILE, MUST USE "os.chdir(os.path.dirname(__file__))",
    #BEFORE IMPORTING, IN ORDER FOR "os.getcwd()", TO BE MATCHED TO "os.path.dirname(sys.argv[0])".
