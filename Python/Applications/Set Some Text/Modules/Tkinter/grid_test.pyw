...
#TO SET GRID CELLS, IN THE APPLICATION WINDOW, THEN USE "tkinter.Label(tkinter.Tk(), text='[TEXT HERE]')" 
#AND ADD ANY FONT OPTIONS WITH "font=('[FONT NAME HERE]', [FONT SIZE HERE], '[FONT STYLE HERE]')",
#THEN USE THE ".grid()" METHOD, TO SET THE TEXT IN THE WINDOW, WITH THE "row" AND "column" OPTIONS SET,
#TO DETERMINE WHICH GRID CELL THE TEXT IS SET IN.
#NOTE: THE "tkinter.Tk().rowconfigure()" AND "tkinter.Tk().columnconfigure()" METHODS'
#"weight" OPTION VALUES, DEFINE HOW EACH CELL FILLS THE WINDOW, WHEN EXPANDED.
#NOTE: THE ".grid()" METHOD'S "sticky" OPTION, CAN BE USED TO POSITION THE TEXT, IN THE GRID CELL.
