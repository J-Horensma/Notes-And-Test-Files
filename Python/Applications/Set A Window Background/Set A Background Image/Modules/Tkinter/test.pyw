...
#SET THE CWD TO THIS FILE'S PATH,
#SO IMAGES ARE LOCATED IN RELATION TO THIS FILE'S PATH
chdir(dirname(__file__))

#TO SET A BACKGROUND IMAGE, SET A VARIABLE, FOR "tkinter.PhotoImage(file='[IMAGE PATH, HERE]')",
#SET THAT VARIABLE, IN A LABEL, AS THE "image" OPTION, LIKE SO: "Label(tkinter.Tk(), image=[VARIABLE, HERE])",
#THEN USE "[LABEL_VARIABLE].place(relheight=1, relwidth=1)", ON THAT LABEL.
