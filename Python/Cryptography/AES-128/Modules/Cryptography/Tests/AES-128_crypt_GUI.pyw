...
def aes_128_encrypt_file_thread(WINDOW, ENCRYPT_FOLDER_BUTTON, DECRYPT_FOLDER_BUTTON, ENCRYPT_FILE_BUTTON, DECRYPT_FILE_BUTTON):
    FILE_PATH = file_path_prompt('Choose A File, To Encrypt')
    PASSWORD = input_string_prompt(WINDOW, 'Enter A Password, To Encrypt The File:')
...
def aes_128_decrypt_file_thread(WINDOW, ENCRYPT_FOLDER_BUTTON, DECRYPT_FOLDER_BUTTON, ENCRYPT_FILE_BUTTON, DECRYPT_FILE_BUTTON):
    FILE_PATH = file_path_prompt('Choose A File, To Decrypt')
    PASSWORD = input_string_prompt(WINDOW, 'Enter A Password, To Decrypt The File:')
