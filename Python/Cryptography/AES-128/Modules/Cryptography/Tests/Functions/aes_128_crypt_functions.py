    ...
    for ROOT, DIRECTORIES, FILES in walk(FOLDER_PATH):
        ...
        for FILE_NAME in FILES:
            ...
            if RESULT[1] == 'FILE_EMPTY':
                ...
                ALREADY_ENCRYPTED_DETECTED = True
            elif RESULT[0] is False:
                return [False, RESULT[1]]
    if ALREADY_ENCRYPTED_DETECTED:
    ...
    for ROOT, DIRECTORIES, FILES in walk(FOLDER_PATH):
        ...
        for FILE_NAME in FILES:
            ...
            if RESULT[1] == 'FILE_EMPTY':
                ...
                INCORRECT_PASSWORD_DETECTED = True
            elif RESULT[0] is False:
                return [False, RESULT[1]]
    if INCORRECT_PASSWORD_DETECTED:
...
def aes_128_encrypt_file(FILE_PATH, PASSWORD, BLOCK_SIZE=None):
    ...
    #DELETE THE PASSWORD VARIABLE, CONTAINING THE USER-ENTERED PASSWORD STRING, FROM THE MEMORY
    del PASSWORD
