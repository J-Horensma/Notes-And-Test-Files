...
#2.) CHECKS IF THE FILE IS EMPTY, AES-128 ENCRYPTED, AND IF THE HEADER INTEGRITY, IS CORRUPTED
#3.) RETURNS THE AES-128 SALT BYTES HEADER AND THE TOTAL SIZE, OF THE HEADER
def check_aes_128_salt_header(FILE):
    ...
    #SANITY CHECK: SALT HEADER SIZE MUST BE REASONABLE
    ...
    #TOTAL HEADER SIZE = 4 BYTES (SIZE FIELD) + SALT BYTES
...
def aes_128_encrypt_file(FILE_PATH, PASSWORD, BLOCK_SIZE=None):
    ...
    try:
        ...
        with open(FILE_PATH, 'rb') as INFILE:
            ...
            CHECK_HEADERS_RESULT = check_aes_128_salt_header(INFILE)
