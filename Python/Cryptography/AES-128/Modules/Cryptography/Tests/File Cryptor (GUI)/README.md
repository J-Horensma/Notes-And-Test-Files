...
#### This application is unsigned, as it costs money to sign applications, therefor, it may trigger a smartscreen warning, in Windows, however, it is a safe application and the source code, is available, in the "test.pyw", as well as the "src" directory, to review.
