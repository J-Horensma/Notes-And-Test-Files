...
#### For Linux and Mac, the "AES-128 File Cryptor.pyw" file, can be used, with the latest Python installed. You can compile the "AES-128 File Cryptor.pyw" file, on your own or use the file, as is.
