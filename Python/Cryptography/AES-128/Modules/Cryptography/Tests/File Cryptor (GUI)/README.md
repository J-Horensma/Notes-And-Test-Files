...
#### The Windows "AES-128 File Cryptor.exe" file, is unsigned, as it costs money to sign an application, therefor, it may trigger a smartscreen warning, in Windows, however, it is a safe application and the source code is available to review for yourself, in the "AES-128 File Cryptor.pyw" file, as well as, the "src" directory.
