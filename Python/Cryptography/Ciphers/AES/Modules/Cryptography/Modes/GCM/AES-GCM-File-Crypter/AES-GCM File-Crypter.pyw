...
For clarity, "software", means "AES-GCM File-Crypter.pyw", "personal", means not for profit, and "commercial", means for profit.
...
def handle_ctrl_z(signum, frame):
    print('\n"Ctrl + z", was pressed, closing AES-GCM File-Crypter...\n')
    ROOT_WINDOW.quit()
