...
while True:
    try:
        ...
        #DATABASE TABLE NAME STRING, ACCOUNT INFORMATION STRING, PASSWORD HASH BYTES, AND SALT BYTES, ARE REQUIRED.
    ...
    #TO CATCH AN EXCEPTION, OF A ROW VALUE THAT HAS A COLUMN, 
