...
try:
    ...
    #AND COLUMN/S INFO, ARE REQUIRED.
    ...
    #THE "is_quoted()" FUNCTION, CAN CHECK IF A STRING IS QUOTED AND THE "unquote()" FUNCTION, CAN UNQUOTE THAT STRING, IF THE STRING IS QUOTED.
    #THE "is_quoted()" AND "unquote()" FUNCTIONS, ARE USEFUL, WHEN WORKING WITH TABLE NAMES.
